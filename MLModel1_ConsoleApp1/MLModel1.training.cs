...
namespace MLModel1_ConsoleApp1
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\Duy\Documents\MyProject\ml_dotnet_NLCS\TestML_NET\Data\dataset.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.ReplaceMissingValues(@"DiemToHop", @"DiemToHop")      
                                    .Append(mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"MaToHop",outputColumnName:@"MaToHop"))      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator: mlContext.BinaryClassification.Trainers.LbfgsLogisticRegression(new LbfgsLogisticRegressionBinaryTrainer.Options(){L1Regularization=0.03125F,L2Regularization=0.78957427F,LabelColumnName=@"NhomNganh",FeatureColumnName=@"Features"}), labelColumnName:@"NhomNganh"))      
