...
namespace TestML_NET
{
    public partial class MLModel1
    {
        ...
        {
            [ColumnName(@"MaToHop")]
            public float[] MaToHop { get; set; }

            [ColumnName(@"DiemToHop")]
            public float DiemToHop { get; set; }

            [ColumnName(@"NhomTinhCach")]
            public float[] NhomTinhCach { get; set; }

            [ColumnName(@"NhomNganh")]
            public uint NhomNganh { get; set; }
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("NhomNganh");
            if (labelColumn == null)
            {
                throw new Exception("NhomNganh column not found. Make sure the name searched for matches the name in the schema.");
            }
